...
contract TimeLock {
    ...
    uint constant  public CYCLE_TIMES = 720;
    uint public fixedQuantity;
    uint public startTime;
    uint public constant delay = 180 days;
    uint public cycle;
...
//        string memory _introduce
        ...
        startTime = _startTime.add(delay);
//        introduce = _introduce;
    ...
    function setBeneficiary(address _newBeneficiary) public {
        require(_newBeneficiary != address (0),"Not zero address");
